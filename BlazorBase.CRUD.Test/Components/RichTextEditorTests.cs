...
using NSubstitute;
using Xunit;
using RichTextEditorComponent = BlazorBase.CRUD.Components.RichTextEditor.RichTextEditor;

namespace BlazorBase.CRUD.Test.Components;

public class RichTextEditorTests : BunitTestContextBase
{
    private const string ModulePath = "./_content/BlazorBase.CRUD/js/richTextEditor.js";
